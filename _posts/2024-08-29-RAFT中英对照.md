...
近年来，深度学习已被证明是传统方法的有前途的替代方案。深度学习可以回避制定优化问题，训练网络直接预测流。当前的深度学习方法  [25,42,22,49,20] 在推理时间上显著更快的同时，达到了与最佳传统方法相媲美的性能。进一步研究的一个关键问题是**设计有效的架构，这些架构表现更好，训练更容易，并且能够很好地泛化到新颖的场景**。
